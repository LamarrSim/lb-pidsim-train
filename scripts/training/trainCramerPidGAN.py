...
print ( "\n\t\t\t\t\t+------------------------------------+"   )
print (   "\t\t\t\t\t|                                    |"   )
print (   "\t\t\t\t\t|        Cramér GAN - training       |"   )
print (   "\t\t\t\t\t|                                    |"   )
print (   "\t\t\t\t\t+------------------------------------+\n" )

parser = argparser ("CramerGAN training")
...
with open (f"config/hyperparams/{args.model.lower()}-cramergan.yml") as file:
...
else          : model_name += ".bc"   # base CramerGAN
