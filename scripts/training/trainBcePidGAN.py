...
from lb_pidsim_train.algorithms.gan import BceGAN
...
print ( "\n\t\t\t\t\t+----------------------------------+"   )
print (   "\t\t\t\t\t|                                  |"   )
print (   "\t\t\t\t\t|        BCE GAN - training        |"   )
print (   "\t\t\t\t\t|                                  |"   )
print (   "\t\t\t\t\t+----------------------------------+\n" )

parser = argparser ("BceGAN training")
...
if sw_avail   : model_name += ".wb"   # BceGAN with weights
else          : model_name += ".bb"   # base BceGAN
